  ...
  return (
    <header className="w-full py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        <motion.p 
          className="mt-3 text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div 
          className="mt-6 flex flex-wrap justify-center gap-2 items-center text-sm text-gray-500 dark:text-gray-400"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <span className="hidden sm:block w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-600"></span>
          <span className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-purple-500" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
